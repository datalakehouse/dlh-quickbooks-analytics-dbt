...
FINAL AS (
    SELECT
        ...
        ,row_number() over (partition by BILLS.K_BILL_DLHK order by BILLS.A_TRANSACTION_DATE asc) AS A_BILL_LINE
        --METRICS
        ,BILL_LINES.M_AMOUNT
        ,round((BILL_LINES.M_AMOUNT / BILLS.M_TOTAL_AMOUNT) * BILLS.M_PAYMENT_AMOUNT,2) AS M_PAID_AMOUNT
        ,round((BILL_LINES.M_AMOUNT / BILLS.M_TOTAL_AMOUNT) * BILLS.M_BALANCE,2) AS M_UNPAID_AMOUNT
