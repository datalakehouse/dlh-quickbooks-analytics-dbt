...
WITH source AS (
  ...
  * 
  FROM  	
    {{source(var('source_schema', 'DEMO_QUICKBOOKS_SANDBOX'),'INVOICE_LINE')}}
),
accounts AS (
...
SELECT
    --DLHK
    MD5( TRIM(COALESCE(CONCAT(I.INVOICE_ID,'-',I.IL_INDEX),'00000000000000000000000000000000')) ) AS K_INVOICE_LINE_DLHK
    ,MD5( TRIM(COALESCE(I.INVOICE_ID,'00000000000000000000000000000000')) ) AS K_INVOICE_DLHK
