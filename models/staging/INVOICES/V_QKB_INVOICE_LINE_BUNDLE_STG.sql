...
SELECT
    --DLHK
    MD5( TRIM(COALESCE(CONCAT(I.INVOICE_ID,'-',I.INVOICE_LINE_INDEX,'-',I.ILB_INDEX),'00000000000000000000000000000000')) ) AS K_INVOICE_LINE_BUNDLE_DLHK
