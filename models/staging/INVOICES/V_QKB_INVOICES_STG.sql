...
FINAL AS (
    ...
    ,I.A_PAYMENT_DATE
    ,I.A_PAYMENT_STATUS
    ,I.A_DAYS_BETWEEN_DUE_DATE_AND_NOW
    ,row_number() over (partition by I.K_INVOICE_DLHK order by I.A_TRANSACTION_DATE asc) AS A_INVOICE_LINE
    ...
    ,IL.M_AMOUNT
    ,round((IL.M_AMOUNT / I.M_TOTAL_AMOUNT) * I.M_PAYMENT_AMOUNT,2) AS M_PAID_AMOUNT
    ,round((IL.M_AMOUNT / I.M_TOTAL_AMOUNT) * I.M_BALANCE,2) AS M_UNPAID_AMOUNT
